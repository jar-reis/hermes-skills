...
| L2/L3 | **Hindsight** | Lesson / experience memory | Hindsight daemon `http://localhost:9876` |
...
3. Port allocations (2026-06-18): Honcho/Cortex uses 8000 (Chroma), OBn uses 8001, Hindsight daemon uses 9876.
4. ContextForge.dev SaaS remains the cross-fleet shared L4; it is separate from the IBM `mcpgateway` at :8090.
